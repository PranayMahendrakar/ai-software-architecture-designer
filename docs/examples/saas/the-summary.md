...
> Build a SaaS project management tool with teams, tasks, milestones, and Slack integrations. Support SSO login, role-based access, webhooks, and an API. The system targets enterprise scale.
...
- **core-service** :8002 — Main business logic for The
